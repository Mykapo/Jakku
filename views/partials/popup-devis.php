        ...
        <form action="" method="post">
            ...
            <div class="prix">
                <div>
                    ...
                    <input class="input-form" id="tarif-journalier" type="number" name="description" placeholder="Saisir">
                </div>
                <p>X</p>
                <div>
                    <label for="jour" class="input-label">Nombre de jour</label>
                    <input class="input-form" id="jour" type="number" name="description" placeholder="Saisir">
                </div>
            </div>
            <div class="button-plus">
                <div id="add-intitule" class="button complete">+</div>
